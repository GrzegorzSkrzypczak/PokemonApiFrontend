...
class PokemonList extends React.Component {
    ...
    componentDidMount() {
        this.fetchPokemonList('https://pokemon-academi-api-grzegorz.herokuapp.com/pokemons/list')
